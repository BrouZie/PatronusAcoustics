...
void MX_MDMA_Init(void)
{
  ...
  hmdma_mdma_channel1_sw_0.Init.DestinationInc = MDMA_DEST_INC_DOUBLEWORD;
  hmdma_mdma_channel1_sw_0.Init.SourceDataSize = MDMA_SRC_DATASIZE_WORD;
  hmdma_mdma_channel1_sw_0.Init.DestDataSize = MDMA_DEST_DATASIZE_DOUBLEWORD;
  ...
  hmdma_mdma_channel1_sw_0.Init.DestBurst = MDMA_DEST_BURST_16BEATS;
